...
4. To calculate the same equation for all rows in the column, click on the cell and then drag the cell's bottom right corner down to the end of your list.</p>__*insert video clip dragging down here*__
 ...
 7. Use these buttons ![Decimal_Buttons](https://github.com/ymonteagudo9896/pierce-hacker-submissions/blob/master/lessons/images/GRY/Decimal_Buttons.png?raw=true) to adjust how many decimal places shown.</p> __*insert video clip adjusting decimals here*__
